        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-4">
            <Card className="flex-1" contentClassName="flex flex-col gap-2">
              ...
              <div className="text-panel-secondary-content flex items-center gap-2 text-sm">
                Design Credits
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-panel-secondary-content">
            ...
            <span className="text-panel-content font-semibold">
              March 15, 2024
            </span>
          </span>
        </div>
        <div className="border-panel-accent flex overflow-hidden rounded-xl border">
          <div className="flex flex-1 flex-col">
            <div className="dark:bg-vulcan light:bg-mystic text-panel-secondary-content px-6 py-4 text-base">
              Selected plan
            </div>
            <div className="text-panel-secondary-content flex-1 px-6 py-4 text-base">
              Team
            </div>
          </div>
          <div className="flex flex-1 flex-col">
            ...
            <div className="text-panel-secondary-content flex flex-1 items-center gap-2 px-6 py-4 text-base">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="17"
                height="16"
                viewBox="0 0 17 16"
                className="text-panel-content mb-px h-4 w-4"
                fill="currentColor"
              >
...
export const BillingInformation = () => {
  ...
  return (
    <motion.div
      ...
      className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm md:min-w-[960px] md:max-w-[1200px]"
    >
      <div className="text-panel-content mb-2 flex justify-between gap-2 rounded-xl border border-primary bg-primary/10 p-8">
        <div className="flex flex-col gap-2">
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              <svg
