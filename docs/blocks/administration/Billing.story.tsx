    ...
    <Card className="p-12 transition-colors">
      <div className="flex flex-col gap-4">
        <div className="flex flex-col">
          ...
          <p className="text-text-content-secondary text-base">
    ...
    colors: {
      ...
      info: {
        ...
        variants: {
          ...
          filled: `${defaultChipTheme?.colors?.info?.variants?.filled} text-text-content-primary bg-info/10 border-info`
        }
      },
      success: {
        ...
        variants: {
          ...
          filled: `${defaultChipTheme?.colors?.success?.variants?.filled} text-text-content-primary bg-success/10 border-success`
        }
      }
    }
  };
      ...
      <Card className="p-12 transition-colors">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-text-content-secondary">
          ...
          <div className="flex gap-4">
            <Card className="flex-1" contentClassName="flex flex-col gap-2">
              ...
              <div className="text-text-content-secondary flex items-center gap-2 text-sm">
                Design Credits
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-text-content-secondary">
            ...
            <span className="text-text-content-primary font-semibold">
              March 15, 2024
            </span>
          </span>
        </div>
        <div className="border-panel-accent flex overflow-hidden rounded-xl border">
          <div className="flex flex-1 flex-col">
            <div className="dark:bg-vulcan light:bg-mystic text-text-content-secondary px-6 py-4 text-base">
              Selected plan
            </div>
            <div className="text-text-content-secondary flex-1 px-6 py-4 text-base">
              Team
            </div>
          </div>
          <div className="flex flex-1 flex-col">
            ...
            <div className="text-text-content-secondary flex flex-1 items-center gap-2 px-6 py-4 text-base">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="17"
                height="16"
                viewBox="0 0 17 16"
                className="text-text-content-primary mb-px h-4 w-4"
                fill="currentColor"
              >
...
export const BillingInformation = () => {
    ...
    colors: {
      ...
      warning: {
        ...
        variants: {
          ...
          filled: `${defaultChipTheme?.colors?.warning?.variants?.filled} text-text-content-primary bg-warning/10 border-warning`
        }
      },
      success: {
        ...defaultChipTheme.colors.success,
  ...
  return (
    <motion.div
      ...
      className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm md:min-w-[960px] md:max-w-[1200px]"
    >
      <div className="text-text-content-primary mb-2 flex justify-between gap-2 rounded-xl border border-primary bg-primary/10 p-8">
        <div className="flex flex-col gap-2">
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              <svg
      ...
      <Card className="p-12 transition-colors">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex w-full">
            <div className="flex flex-1 flex-col">
              <div className="border-panel-accent border-b px-4 py-2">
                <span className="text-text-content-secondary text-base">
                  Invoice Date
                </span>
              </div>
              <motion.div
                ...
                className="border-panel-accent flex-1 border-b px-4 py-5"
              >
