...
import { toggleTheme as toggleThemeDefault, Toggle, ToggleTheme } from '../../../src/form/Toggle';
import { radioTheme as radioThemeDefault, Radio, RadioTheme } from '../../../src/form/Radio';
...
import { cn, mergeDeep, mergeThemeClasses } from '../../../src/utils/Theme/helpers';
...
const radioTheme: RadioTheme = mergeDeep(radioThemeDefault, {
  base: 'box-border leading-3',
  radio: {
    base: 'will-change-[border-color] inline-flex justify-center items-center box-border align-middle rounded-full bg-transparent border border-block-radio-border cursor-pointer focus-visible:outline-hidden focus-visible:border-primary-hover',
  ...
  return (
    <MotionGroup className="w-full grid grid-cols-3 gap-2.5">
      <MotionItem>
        <Card
          className={cn('w-full h-[515px] rounded-sm transition-colors', {
            'bg-block-card-bg-alt': selected !== 'free',
            'border-block-selected-border bg-block-card-bg':
              selected === 'free'
          })}
      ...
      <MotionItem>
        <Card
          className={cn('w-full h-[515px] rounded-sm transition-colors', {
            'bg-block-card-bg-alt': selected !== 'starter',
            'border-block-selected-border bg-block-card-bg':
              selected === 'starter'
          })}
          contentClassName="w-full h-full"
        >
          <div className="flex flex-col items-start gap-2.5 h-full">
            <div className="flex items-center gap-2.5 justify-between w-full">
              ...
              <Chip
                color="success"
                className="rounded-full px-3 text-sm bg-success-background text-text-primary"
              >
                Recommended
              </Chip>
            </div>
      ...
      <MotionItem>
        <Card
          className={cn('w-full h-[515px] rounded-sm transition-colors', {
            'bg-block-card-bg-alt': selected !== 'custom',
            'border-block-selected-border bg-block-card-bg':
              selected === 'custom'
          })}
          contentClassName="w-full h-full"
  ...
  return (
    <Card className="w-full transition-colors" contentClassName="w-full h-full">
      <div className="flex items-center gap-2.5 justify-between">
        <div className="flex items-center gap-2.5">
          <div className="bg-block-soft/40 rounded-xs p-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        <div className="flex items-center gap-1 bg-block-track rounded-sm p-1">
          {['Monthly', 'Yearly'].map(type => (
            <Button
              key={type}
              size="large"
              className={cn('text-lg transition-colors', {
                'bg-block-soft text-text-primary': cycle === type,
      ...
      <MotionGroup className="flex flex-col gap-2.5 mt-7">
        <div className="grid grid-cols-[400px_1fr_1fr_1fr] gap-2.5">
          ...
          <MotionItem className="flex flex-col">
            ...
            <div className="h-2.5" />
            <div className="bg-block-soft/40 py-2 px-4 rounded-xs flex gap-2 items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="17"
                height="16"
          ...
          <MotionItem className="flex flex-col">
            ...
            <Button
              color="primary"
              className="px-4 py-2 text-lg gap-2 bg-(image:--button-gradient) bg-block-cta! hover:bg-(image:--block-cta-image-hover) hover:bg-block-cta-hover! focus:bg-(image:--block-cta-image-focus) focus:bg-block-cta-focus! focus:outline-hidden transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="17"
  ...
  return (
    ...
    >
      <Card
        ...
        headerClassName="border-b border-block-divider px-7 pt-7 pb-2"
        header={
          <div className="flex items-center gap-2.5 justify-between w-full">
            <div>
            ...
            <Button className="p-3 bg-block-soft/40 hover:bg-block-soft/60 focus:bg-block-soft/60 text-text-secondary transition-colors">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
      ...
      >
        <div className="p-7">
          ...
          <MotionGroup className="grid grid-cols-2 gap-4 mt-4">
            <MotionItem>
              <Card
                className={cn('px-5 py-7', {
                  'border-solid border-transparent rounded-sm [border-image:var(--block-card-border-image)] bg-block-highlight/40':
                    isFree
                })}
              >
                <div className="flex items-center gap-2.5">
            ...
            <MotionItem>
              <Card
                className={cn('px-5 py-7', {
                  'border-solid border-transparent [border-image:var(--block-card-border-image)] bg-block-highlight/40':
                    !isFree
                })}
              >
                <div className="flex items-center gap-2.5">
        ...
        <div className="border-t border-block-divider p-7">
          <div className="flex flex-row-reverse items-center gap-2.5">
            <Button
              color="primary"
              className="px-4 py-2 text-lg bg-(image:--button-gradient) bg-block-cta! hover:bg-(image:--block-cta-image-hover) hover:bg-block-cta-hover! focus:bg-(image:--block-cta-image-focus) focus:bg-block-cta-focus! focus:outline-hidden transition-colors"
              end={
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
