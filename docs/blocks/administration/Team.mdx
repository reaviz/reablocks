...
<Unstyled>
  <Tabs direction="rtl">
    ...
    <TabPanel>
      <div className="light:bg-mystic light:text-black flex flex-col border justify-center items-center border-gray-500 p-7">
        <TeamGeneral />
      </div>
    </TabPanel>
    <TabPanel>
...
import { Card, Tabs, Tab, TabList, TabPanel, Avatar, Button, IconButton, Checkbox, CheckboxTheme, checkboxTheme as defaultCheckboxTheme, Stack } from 'reablocks';
...
import { motion } from 'framer-motion';
import React, { FC, useState } from 'react';
import { Avatar, Button, Card, Checkbox, CheckboxTheme, checkboxTheme as defaultCheckboxTheme, Divider, IconButton, Stack } from 'reablocks';
...
import { Avatar, Button, IconButton, Input, Card, Divider, Stack, Tab, TabList, TabPanel, Tabs } from 'reablocks'
