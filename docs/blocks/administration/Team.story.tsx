          ...
          <TabPanel>
            <div className="flex w-full justify-between items-center mb-4">
              <div className="flex flex-col">
                ...
                <span className="text-base text-text-content-secondary">
                ...
                <tbody>
                  {Array(10)
                    ...
                    .map((user, index) => (
                      <>
                        <tr
                          className="border-b border-panel-accent hover:bg-panel-accent/40 transition-colors text-base text-text-content-secondary"
                          key={index}
                        >
                          ...
                          <td className="py-6 pl-4">
                            <div className="flex gap-2 items-center">
                              <svg
                                ...
                                height="16"
                                viewBox="0 0 16 16"
                                className="text-text-content-primary"
                                fill="currentColor"
                              >
        ...
        <TabPanel className="flex flex-col gap-2 mt-8">
          ...
          <div className="rounded-xl overflow-auto max-h-[300px]">
            <table className="w-full">
              <thead className="sticky top-0 left-0 text-left text-text-content-secondary text-base dark:bg-vulcan light:bg-gray-200">
                <tr>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="w-full flex gap-12  ">
            ...
            <div className="flex-1 rounded-xl overflow-auto">
              <table className="w-full">
                <thead className="text-left text-text-content-secondary text-base dark:bg-vulcan light:bg-gray-200">
                  <tr>
