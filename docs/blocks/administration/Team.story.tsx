    ...
    >
      <Card className="transition-colors p-12">
        <div className="flex flex-col gap-4">
          ...
          <div>
            <Tabs size="large" variant="secondary" selectedIndex={1}>
              <TabList>
            ...
            <TabPanel>
                          ...
                          >
                            ...
                            <td className="py-6 pl-4">
                              <div className="flex gap-2 items-center">
                                <Avatar src="https://avatars.githubusercontent.com/u/227909?s=96&v=4" />
                                {user.name}
                              </div>
                            </td>
                            <td className="py-6 pl-4">
                              <div className="flex gap-2 items-center">
                                <svg
                                  ...
                                  height="16"
                                  viewBox="0 0 16 16"
                                  className="text-content-text-neutral-base"
                                  fill="currentColor"
                                >
              ...
              <Pager
                className="[&_div:first-child]:flex-1 pt-4"
                page={2}
                size={5}
                total={15}
                displayMode="all"
