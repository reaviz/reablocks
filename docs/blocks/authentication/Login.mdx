...
<Tabs direction="rtl">
  ...
  <TabPanel>
```tsx
import { Block, Button, Card, Checkbox, Divider, Input, Stack } from 'reablocks';
import { motion } from 'framer-motion';
import { useForm, Controller } from 'react-hook-form';
...
<Tabs direction="rtl">
  ...
  <TabPanel>
    <div className="light:bg-white light:text-black flex flex-col border justify-center items-center min-h-[780px] border-gray-700">
      <LoginFull />
    </div>
  </TabPanel>
  <TabPanel>
