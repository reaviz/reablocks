...
<Unstyled>
  <Tabs direction="rtl">
    ...
    <TabPanel>
      <div className="flex light:bg-white light:text-black flex-col border justify-center items-center min-h-[840px] border-gray-700">
        <div className="min-w-[600px] flex justify-center items-center">
          <Mfa />
        </div>
      </div>
    </TabPanel>
