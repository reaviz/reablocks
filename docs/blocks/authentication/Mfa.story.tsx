...
const QRIcon = ({ className }: { className?: string }) => (
  ...
  >
    <g clipPath="url(#clip0_1447_18003)">
      <path d="M200 0H0V200H200V0Z" className="fill-panel" />
      <mask
        id="mask0_1447_18003"
      ...
      <g mask="url(#mask1_1447_18003)">
        <path d="M55 13H13V55H55V13Z" fill="currentColor" />
      </g>
      <mask
        id="mask2_1447_18003"
        style={{ maskType: 'luminance' }}
      ...
      <g mask="url(#mask2_1447_18003)">
        <path d="M43 25H25V43H43V25Z" fill="currentColor" />
      </g>
      <mask
        id="mask3_1447_18003"
        style={{ maskType: 'luminance' }}
      ...
      <g mask="url(#mask3_1447_18003)">
        <path d="M187 13H145V55H187V13Z" fill="currentColor" />
      </g>
      <mask
        id="mask4_1447_18003"
        style={{ maskType: 'luminance' }}
      ...
      <g mask="url(#mask4_1447_18003)">
        <path d="M175 25H157V43H175V25Z" fill="currentColor" />
      </g>
      <mask
        id="mask5_1447_18003"
        style={{ maskType: 'luminance' }}
      ...
      <g mask="url(#mask5_1447_18003)">
        <path d="M55 145H13V187H55V145Z" fill="currentColor" />
      </g>
      <mask
        id="mask6_1447_18003"
        style={{ maskType: 'luminance' }}
      ...
      <g mask="url(#mask6_1447_18003)">
        <path d="M43 157H25V175H43V157Z" fill="currentColor" />
      </g>
    </g>
    <defs>
      ...
      <Card className="w-full">
        ...
        <form onSubmit={handleSubmit(values => console.log('values', values))}>
          ...
          <Button
            ...
            variant="filled"
            color="primary"
            className="mt-7 rounded-xs px-4 py-2 flex items-center gap-2 self-stretch text-lg! bg-(image:--button-gradient) bg-block-cta! hover:bg-(image:--block-cta-image-hover) hover:bg-block-cta-hover! focus:bg-(image:--block-cta-image-focus) focus:bg-block-cta-focus! focus:outline-hidden transition-colors"
            disabled={isSubmitting}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <Card className="w-full p-[50px]">
        <div className="flex flex-col pt-2 pb-5">
          ...
          <div className="self-center mt-4 mb-6">
            <QRIcon className="text-text-primary" />
          </div>
        </div>
        <form onSubmit={handleSubmit(values => console.log('values', values))}>
