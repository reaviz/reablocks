    ...
    >
      <Card className="w-full">
        <div className="flex flex-col items-center justify-center pt-2 pb-5 text-center">
          ...
          <h1 className="mt-2 mb-0 text-2xl font-sans font-bold">One Time Password</h1>
          <div className="text-accent">Please verify your identity using your registered email or phone number and follow the prompts to complete the password reset process.</div>
        </div>
        <form onSubmit={handleSubmit(values => console.log('values', values))}>
          ...
          <div className="text-center text-accent text-sm mt-5">
