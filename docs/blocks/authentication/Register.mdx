...
import { RegisterWithSocial } from './RegisterWithSocial';
      ...
      <Card className="w-full p-12">
        ...
        >
          ...
          <div className="mt-5 text-sm text-panel-secondary-content flex items-center justify-center gap-2">
            ...
            <a href="#" className="text-primary hover:text-primary-hover text-lg">
              terms of service
            </a>
            and
            <a href="#" className="text-primary hover:text-primary-hover text-lg">
...
<Unstyled>
  <Tabs direction="rtl">
    ...
    <TabPanel>
      <div className="flex flex-col border justify-center items-center border-gray-700 light:bg-white light:text-black">
        <RegisterFull />
      </div>
    </TabPanel>
    <TabPanel>
