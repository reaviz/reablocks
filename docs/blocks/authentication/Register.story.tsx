      ...
      <Card className="w-full p-12">
        ...
        >
          ...
          <Button
            ...
            variant="filled"
            color="primary"
            className="mt-5 mb-2 flex items-center gap-2 self-stretch text-lg! bg-(image:--button-gradient) bg-block-cta! hover:bg-(image:--block-cta-image-hover) hover:bg-block-cta-hover! focus:bg-(image:--block-cta-image-focus) focus:bg-block-cta-focus! focus:outline-hidden transition-colors"
            disabled={isSubmitting}
          >
      ...
      <Card className="w-full p-12">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card
              className={cn(
                'p-5 bg-block-option hover:cursor-pointer hover:bg-block-option-hover transition-colors',
                {
                  'border-primary bg-block-option-selected hover:bg-block-option-selected':
                    selection === 'starter'
                }
              )}
          ...
          <div className="flex flex-col items-center justify-between md:flex-row">
            ...
            <div>
              <Button
                ...
                variant="filled"
                color="primary"
                className="mt-5 mb-2 px-4 py-2 flex items-center gap-2 self-stretch text-lg! bg-(image:--button-gradient) bg-block-cta! hover:bg-(image:--block-cta-image-hover) hover:bg-block-cta-hover! focus:bg-(image:--block-cta-image-focus) focus:bg-block-cta-focus! focus:outline-hidden transition-colors"
                disabled={isSubmitting}
              >
      ...
      <Card className="w-full p-12">
        ...
        >
          ...
          <Button
            ...
            variant="filled"
            color="primary"
            className="mt-7 mb-2 flex items-center gap-2 self-stretch text-lg! bg-(image:--button-gradient) bg-block-cta! hover:bg-(image:--block-cta-image-hover) hover:bg-block-cta-hover! focus:bg-(image:--block-cta-image-focus) focus:bg-block-cta-focus! focus:outline-hidden transition-colors"
            disabled={isSubmitting}
          >
            {isSubmitting ? 'Signing up...' : 'Sign up →'}
          </Button>
