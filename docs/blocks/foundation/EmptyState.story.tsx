...
export const MissingInfo = () => (
  ...
  >
    ...
    >
      ...
      />
      <Button
        className="mt-6 w-fit font-semibold px-4 py-2 border-none bg-(image:--button-gradient) bg-block-cta! hover:bg-(image:--block-cta-image-hover) hover:bg-block-cta-hover! focus:bg-(image:--block-cta-image-focus) focus:bg-block-cta-focus! focus:outline-hidden transition-colors"
        color="primary"
        start={
          <svg
            xmlns="http://www.w3.org/2000/svg"
