...
export const MissingInfo = () => (
  ...
  >
    ...
    >
      ...
      />
      <Button
        className="mt-6 w-fit font-semibold px-4 py-2 border-none bg-(image:--button-gradient) hover:bg-(image:--button-gradient-hover) focus:bg-(image:--button-gradient-focus) focus:outline-hidden transition-colors"
        start={
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
