...
<Meta title="Blocks/Foundation/Support" />

# Support
The Support block provides a way to provide the user the ability to contact support.
...
<Unstyled>
  <Tabs direction="rtl">
    ...
    <TabPanel>
```tsx
import { Input, Button, Card, Block, Texarea } from '../../../src/form/Input';
