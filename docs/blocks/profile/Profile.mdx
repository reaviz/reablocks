...
### Simple Profile
The Simple Profile block offers a straightforward layout for displaying and editing basic user information such as name, email, and company.
<Tabs direction="rtl">
  <TabList>
    <Tab>
      Demo
  ...
  <TabPanel>
    <div className="flex flex-col border justify-center items-center min-h-[540px] border-gray-500">
      <Profile />
    </div>
  </TabPanel>
  <TabPanel>
