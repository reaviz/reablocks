...
might ask yourself when you take a look at this library is
why another component library; don't we have enough? It's true,
...
but they come with a number of drawbacks. Let's take a look at these real quick:
...
Reablocks is designed to not have a design out of the box. We plan to offer themes and provide lots of examples of how to make them beautiful but not having a design is our priority. This lets you avoid all the nasty overrides and focus on building the product your team needs.
...
Reablocks is designed to use native CSS features such as CSS variables.
...
Reablocks (and all the Reaviz projects for that matter) are all built on Framer-Motion.
