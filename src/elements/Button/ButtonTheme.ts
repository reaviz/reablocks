...
export const defaultButtonTheme: ButtonTheme = {
  ...
  disabled:
    'disabled:cursor-not-allowed data-[variant=filled]:disabled:bg-secondary-inactive/20 disabled:text-secondary-inactive data-[variant=outline]:disabled:border-secondary-inactive',
  ...
  colors: {
    ...
    primary: {
      ...
      outline: 'border border-primary text-primary hover:text-primary-hover',
    ...
    secondary: {
      ...
      outline:
        'border border-secondary text-secondary hover:text-secondary-hover',
      text: 'text-secondary hover:text-secondary-hover',
      ghost: ''
    },
    destructive: {
      filled: 'bg-error hover:bg-error-hover border-error text-white',
      outline: 'border border-error text-error hover:text-error-hover',
