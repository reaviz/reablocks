export const themeV9 = {
  components: {
    ...
    badge: {
      ...
      disableMargins: 'm-0',
      badge:
        'flex flex-row flex-wrap justify-center content-center items-center absolute box-border\n   leading-none text-sm p-1.5 w-[18px] h-[18px] z-1 rounded-[50%] pointer-events-none ',
      position:
      ...
      colors: {
        default: {
          variants: {
            ...
            outline:
              'text-text-primary dark:border-gray-100 light:border-gray-900'
          },
          selectable: {
